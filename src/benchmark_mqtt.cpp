...
//Note from a very annoying guy: you have two duplicated functions with only the pin changing.
//Chanlenge: reshape this part without changing anything anywhere else :)
